...
export default function QueuePanel() {
  const {
    ...
    removeFromQueue, moveInQueue, playTrack, togglePlay, toggleQueue
  } = usePlayer();
        ...
        {currentTrack && (
          <div className="mb-4">
            ...
            <div className="flex items-center gap-3 px-2 py-2 rounded-md bg-white/10">
              <img src={currentTrack.thumbnail} alt="" className="w-10 h-10 rounded object-cover bg-neutral-800 shrink-0" />
